...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.com/users/787619274097033226';
      break;
    case 'github':
      url = 'https://github.com/anshxx99';
      break;
    case 'youtube':
      url = 'https://www.youtube.com/@anshxx99';
      break;
  }
...
function typerStartTyping(typer) {
  ...
  let text = ['minecraft server', 'basic bukkit plugin'];
